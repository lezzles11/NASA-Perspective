      ...
      <div className="mask rgba-black-light d-flex justify-content-center align-items-center">
        <div className="container">
          <div className="row justify-content-center">
            <h1 className="font17   h1-reponsive white-text font-weight-bold mb-0 pt-md-5 pt-5">
              <strong>{quote}</strong>
            </h1>
          </div>
          <br />
          ...
          <div style={bottom} className="fixed-bottom row justify-content-end">
            <a
              href="https://www.theschooloflife.com/thebookoflife/how-science-could-at-last-properly-replace-religion/"
              target="_blank"
            >
              <button
                className="btn btn-outline-white wow fadeInDown"
